.class public final Lnz/co/realestate/android/lib/eo/server/job/image/RESDownloadAgentImageJob;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lnz/co/realestate/android/lib/eo/server/job/image/RESDownloadAgentImageJob$Config;
    }
.end annotation
...
# static fields
.field private static final MAX_AGENT_IMAGE_WIDTH:I = 0xfa
...
.method public static getFileLocationFromUrl(Ljava/lang/String;)Ljava/lang/String;
    .locals 7
    ...
    invoke-static {}, Lnz/co/realestate/android/lib/core/RESApplicationBase;->getAgentImagesFolder()Ljava/lang/String;
...
.method public execute(Landroid/content/Context;Landroid/os/Bundle;Landroid/os/Handler;)Ljava/io/File;
    ...
    check-cast v2, Lnz/co/realestate/android/lib/eo/server/job/image/RESDownloadAgentImageJob$Config;

    .line 60
    .local v2, "config":Lnz/co/realestate/android/lib/eo/server/job/image/RESDownloadAgentImageJob$Config;
    invoke-static {v2}, Lnz/co/realestate/android/lib/eo/server/job/image/RESDownloadAgentImageJob$Config;->access$000(Lnz/co/realestate/android/lib/eo/server/job/image/RESDownloadAgentImageJob$Config;)Ljava/lang/String;

    move-result-object v8

    .line 63
    .local v8, "url":Ljava/lang/String;
    invoke-static {v8}, Lnz/co/realestate/android/lib/eo/server/job/image/RESDownloadAgentImageJob;->getFileLocationFromUrl(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v11, "error downloading agent image file"
...
.method public bridge synthetic execute(Landroid/content/Context;Landroid/os/Bundle;Landroid/os/Handler;)Ljava/lang/Object;
    ...
    .prologue
    .line 23
    invoke-virtual {p0, p1, p2, p3}, Lnz/co/realestate/android/lib/eo/server/job/image/RESDownloadAgentImageJob;->execute(Landroid/content/Context;Landroid/os/Bundle;Landroid/os/Handler;)Ljava/io/File;
