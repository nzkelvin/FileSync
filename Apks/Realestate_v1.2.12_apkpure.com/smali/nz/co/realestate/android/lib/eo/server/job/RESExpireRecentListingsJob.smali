.class public final Lnz/co/realestate/android/lib/eo/server/job/RESExpireRecentListingsJob;
.super Lnz/co/realestate/android/lib/eo/server/core/RESServerRequestJob;
.source "RESExpireRecentListingsJob.java"
...
.method public execute(Landroid/content/Context;Landroid/os/Bundle;Landroid/os/Handler;)Ljava/lang/Integer;
    ...
    invoke-virtual {v5}, Lnz/co/realestate/android/lib/core/RESDbHelperBase;->getDbRecentPropertyListing()Lnz/co/realestate/android/lib/eo/database/RESDbRecentPropertyListing;
    ...
    invoke-virtual {v1, v2, v5}, Lnz/co/realestate/android/lib/eo/database/RESDbRecentPropertyListing;->getAllItemsCursor(Landroid/database/sqlite/SQLiteDatabase;Z)Landroid/database/Cursor;
    ...
    .line 36
    const-string v5, "recentpropertylisting_listing_id"
...
.method public bridge synthetic execute(Landroid/content/Context;Landroid/os/Bundle;Landroid/os/Handler;)Ljava/lang/Object;
    ...
    .prologue
    .line 22
    invoke-virtual {p0, p1, p2, p3}, Lnz/co/realestate/android/lib/eo/server/job/RESExpireRecentListingsJob;->execute(Landroid/content/Context;Landroid/os/Bundle;Landroid/os/Handler;)Ljava/lang/Integer;
...
.method public bridge synthetic handleException(Landroid/content/Context;Landroid/os/Bundle;Ljava/lang/Exception;Landroid/os/Handler;)Ljava/lang/Object;
    ...
    .prologue
    .line 22
    invoke-virtual {p0, p1, p2, p3, p4}, Lnz/co/realestate/android/lib/eo/server/job/RESExpireRecentListingsJob;->handleException(Landroid/content/Context;Landroid/os/Bundle;Ljava/lang/Exception;Landroid/os/Handler;)Ljava/lang/Integer;
